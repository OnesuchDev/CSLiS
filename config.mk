...
ifeq ($(DBG_OPT),y)
XOPTS += -ggdb -O $(CC_OPT2) $(CC_OPT3) $(CC_OPT4) $(CC_OPT5)
else
XOPTS += $(CC_OPTIMIZE) $(CC_OPT2) $(CC_OPT3) $(CC_OPT4) $(CC_OPT5) -DINLINE=inline -DSTATIC=static -std=gnu11 -fomit-frame-pointer
endif
...
XOPTS += -D_X86_64_LIS_ -mno-red-zone -pipe
endif
